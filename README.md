...
# All the statistics of the topological features of normal and different cancer types are listed in the Table 2 sheet of "clinical cancer classification data separated.xlsx" file
